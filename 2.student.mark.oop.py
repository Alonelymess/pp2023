...
class Course(Utils):
    ...
    def set_Students_learnt(self, students_list, courses_id): 
        ...
        for i in range(count):
            ...
            mark = int(input('Enter mark of this student: '))
    ...
    def show_Course(self):
        print(f'    Name: {self.get_Name()}    ID: {self.get_Id()}    Credits: {self.get_Credits()}')
...
class Manager(Utils):
    ...
    def search_Student(self):
        ...
        for i in self.__student_manager.get_Student_list():
            if i.get_Id() == student_id:
                print(f'    Name: {i.get_Name()}    ID: {i.get_Id()}   Date of birth: {i.get_Dob()}')
    ...
    def search_Course(self):
        ...
        for i in self.__course_manager.get_Course_list():
            if i.get_Id() == course_id:
                print(f'    Name: {i.get_Name()}    ID: {i.get_Id()}')

                for k in i.get_Students_learnt():
                    print(f'    Student in this course: {k[0].get_Name()}    ID: {k[0].get_Id()}    Mark: {k[1]}')
